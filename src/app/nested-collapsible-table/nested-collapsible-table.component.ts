...
@Component({
  selector: 'app-nested-collapsible-table',
  templateUrl: './nested-collapsible-table.component.html',
  styleUrls: ['./nested-collapsible-table.component.css'],
  animations: [
...
export class NestedCollapsibleTableComponent {
